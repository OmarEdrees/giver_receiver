...
class ChatssRecipientScreen extends StatelessWidget {
  ChatssRecipientScreen({super.key});
      ...
      body: Directionality(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              const CustomHeader(icon: Icons.chat, title: "الدردشات"),
